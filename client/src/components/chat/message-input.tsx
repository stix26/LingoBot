...
export default function MessageInput({
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-gradient-to-t from-background via-background/95 to-background/90 backdrop-blur-lg pb-6 pt-4 px-2 sm:px-4 border-t border-blue-500/20 dark:border-blue-400/20">
